...
async def main(
    *,
    ...
    # ── Aggregation Filters ───────────────────────────────────────────
    app_id: Annotated[
        int, Parameter(help="ID found in.. Subcription Settings > App > in the URL")
    ] = -323232,
    updated_since: Annotated[
        dt.date | None, Parameter(help="Compared against feature.lastUpdatedAt")
    ] = None,
    created_since: Annotated[
        dt.date | None, Parameter(help="Compared against feature.createdAt")
    ] = None,
