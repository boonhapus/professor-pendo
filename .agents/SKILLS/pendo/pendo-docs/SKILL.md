...
1. **Key details** — Include config options, code snippets, or step-by-step instructions as appropriate.
1. **Source link** — Always end with a clearly labeled documentation link:
